...
void shellSort(vector<int>& arr) {
    int n = arr.size();
    //vector<int>& arr - функция принимает вектор целых чисел по ссылке (изменения будут в исходном векторе)

    //arr.size() - возвращает количество элементов в векторе

       // int n = arr.size() - сохраняет размер вектора в переменную n для дальнейшего использования
